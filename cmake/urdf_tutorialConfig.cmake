...
if("FALSE" STREQUAL "TRUE")
  set(urdf_tutorial_SOURCE_PREFIX /tmp/buildd/ros-indigo-urdf-tutorial-0.2.3-0trusty-20141230-0509)
  set(urdf_tutorial_DEVEL_PREFIX /tmp/buildd/ros-indigo-urdf-tutorial-0.2.3-0trusty-20141230-0509/obj-x86_64-linux-gnu/devel)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@willowgarage.com>' to fix it.")
    endif()
